...
{
	mlx_image_to_window
		(game->mlx, game->image_bot_1, x * TILE_SIZE, y * TILE_SIZE);
	mlx_image_to_window
		(game->mlx, game->image_bot_2, x * TILE_SIZE, y * TILE_SIZE);
	mlx_image_to_window
		(game->mlx, game->image_bot_3, x * TILE_SIZE, y * TILE_SIZE);
	mlx_image_to_window
		(game->mlx, game->image_bot_4, x * TILE_SIZE, y * TILE_SIZE);
	mlx_image_to_window
		(game->mlx, game->image_bot_5, x * TILE_SIZE, y * TILE_SIZE);
	mlx_image_to_window
		(game->mlx, game->image_bot_6, x * TILE_SIZE, y * TILE_SIZE);
	mlx_set_instance_depth
		(&game->image_bot_1->instances[game->image_bot_1->count - 1], BOT);
	mlx_set_instance_depth
		(&game->image_bot_2->instances[game->image_bot_2->count - 1], BOT -10);
	mlx_set_instance_depth
		(&game->image_bot_3->instances[game->image_bot_3->count - 1], BOT -10);
	mlx_set_instance_depth
		(&game->image_bot_4->instances[game->image_bot_4->count - 1], BOT -10);
	mlx_set_instance_depth
		(&game->image_bot_5->instances[game->image_bot_5->count - 1], BOT -10);
	mlx_set_instance_depth
		(&game->image_bot_6->instances[game->image_bot_6->count - 1], BOT -10);
}
